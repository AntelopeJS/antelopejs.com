...
Executes the tests defined in your module's test directory to verify functionality. You can run all tests or specify particular test files.
...
| Option   | Short | Description                                          | Default        |
| -------- | ----- | ---------------------------------------------------- | -------------- |
| `--file` | -f    | Specific test file to run (can be used multiple times) | All test files |
...
ajs module test my-module --file dist/test/database.test.js

# Run multiple specific test files
ajs module test my-module -f dist/test/auth.test.js -f dist/test/api.test.js
```
